...
public class Student {
    ...
    public static class Builder{ //only for taking input, validating input and creating student object
        private int id;
        private String name;
        private String universityName;
        private int gradYear;
        ...
        //setter with return type of Builder
        ...
        private void validate()  {
            if(this.gradYear > 2023){
                throw new GradYearInvalidException("Grad year should be less than or equal to 2023");
            }
            if(this.name == null){
